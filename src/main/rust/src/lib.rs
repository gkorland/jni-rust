...
#[no_mangle]
pub extern "system" fn Java_jnirs_HelloWorld_hello(
    env: JNIEnv,
...
#[no_mangle]
pub extern "system" fn Java_jnirs_HelloWorld_helloByte(
    env: JNIEnv,
    _class: JClass,
    input: jbyteArray,
) -> jbyteArray {
...
#[no_mangle]
pub extern "system" fn Java_jnirs_HelloWorld_factAndCallMeBack(
    env: JNIEnv,
    _class: JClass,
    n: jint,
    callback: JObject,
...
#[no_mangle]
pub unsafe extern "system" fn Java_jnirs_HelloWorld_counterNew(
    env: JNIEnv,
    _class: JClass,
    callback: JObject,
) -> jlong {
...
#[no_mangle]
pub unsafe extern "system" fn Java_jnirs_HelloWorld_counterIncrement(
    env: JNIEnv,
    _class: JClass,
    counter_ptr: jlong,
) {
...
#[no_mangle]
pub unsafe extern "system" fn Java_jnirs_HelloWorld_counterDestroy(
    _env: JNIEnv,
    _class: JClass,
    counter_ptr: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_jnirs_HelloWorld_asyncComputation(
    env: JNIEnv,
    _class: JClass,
    callback: JObject,
) {
